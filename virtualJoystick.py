...
class VirtualThrustmaster:
    ...
    def clear_states(self):
        # Center all axes, reset hat switch, and clear button states.
        ...
        self.joystick.set_axis(pyvjoy.HID_USAGE_RZ, center_value)
    ...
    def create_twist_slider(self, root):
        # Twist axis (RZ) slider UI with auto-centering on release.
        self.twist_frame = tk.LabelFrame(root, text="Twist Axis")
        self.twist_frame.pack(padx=10, pady=10)
        self.twist_slider = tk.Scale(self.twist_frame, from_=0, to=AXIS_MAX, orient=tk.HORIZONTAL, length=300,
                                     command=self.on_twist_change)
        self.twist_slider.set(AXIS_MAX // 2)
        self.twist_slider.pack()
        self.twist_slider.bind("<ButtonRelease-1>", self.on_twist_release)

    def on_twist_change(self, value):
        twist_value = int(value)
        self.joystick.set_axis(pyvjoy.HID_USAGE_RZ, twist_value)

    def on_twist_release(self, event):
        center = AXIS_MAX // 2
        self.twist_slider.set(center)
        self.joystick.set_axis(pyvjoy.HID_USAGE_RZ, center)
