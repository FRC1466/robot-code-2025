...
public class DriveTrajectory extends Command {
  ...
  public DriveTrajectory(CommandSwerveDrivetrain drive, HolonomicTrajectory trajectory) {
    this(drive, trajectory, false);
  }

  public DriveTrajectory(
      CommandSwerveDrivetrain drive, HolonomicTrajectory trajectory, boolean mirror) {
    this(drive, trajectory, () -> drive.getState().Pose, mirror);
  }
  ...
  public void execute() {
    ...
    // Command drive - updated to match the new pattern
